      ...
      <header className="mx-10 mb-10">
        <nav>
          <ul className="flex items-center justify-center">
            <li>
              <Link href="/">
                <a className={`block hover:bg-gray-100 transform font-custom-fontFamily font-bold text-custom-darkgray transition border-custom-darkgray md:p-4 p-1 md:mx-4 my-2 mx-1 text-base md:text-xl ${
